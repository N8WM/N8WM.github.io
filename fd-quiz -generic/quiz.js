...
function nextQ() {
  if (qnum < 15) {
    ...
    alert("(hahaha \"Beano\" you get it?)\nCongratulations, you have passed the impossible test! Here is your Father's Day card...");
    showCard();
  }
}
...
var questions = [
  ...
  [
    "In Boy Scouts, which two pictures go together to represent the eleventh essential (recently appended due to complaints about {father's name})?",
